...
import backgroundImage from '../assets/wallpaper.gif'
...
const MessagePage = () => {
  ...
  const handleEmojiClick = (emojiObject) => {
    ...
    if (emojiObject) {
      ...
      console.error("Emoji object is undefined or doesn't contain emoji property");
    }
  };
    ...
    <div style={{ backgroundImage: `url(${backgroundImage})` }} className='bg-no-repeat bg-cover'>
      ...
      <section className='h-16 bg-white flex items-center px-4'>
        <div className='relative flex flex-cols'>
          ...
          <button onClick={() => setOpenEmojiPicker(preve => !preve)} className='flex justify-center items-center w-11 h-11 rounded-full hover:bg-primary hover:text-white'>
            <FaSmileBeam size={20} />
          </button>
