        ...
        <div className='w-full h-full grid grid-cols-[48px,1fr] bg-white'>
            <div className='bg-slate-200 w-12 h-full rounded-tr-lg rounded-br-lg py-5 text-black flex flex-col justify-between'>
                <div>
                    ...
                    <div title='add friend' onClick={() => setOpenSearchUser(true)} className='w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-white rounded' >
                        <FaUserPlus size={20} />
                    </div>
                </div>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <button title='logout' className='w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-white rounded' onClick={handleLogout}>
                        <span className='-ml-2'>
                            <BiLogOut size={20} />
                        </span>
                    </button>
